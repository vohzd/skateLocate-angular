...
(function(root, factory) {
  ...
  (function() {
    ...
    var __MapController = function($scope, $element, $attrs, $parse, _Attr2MapOptions_, NgMap, NgMapPool) {
      ...
      vm.zoomToIncludeMarkers = function() {
        ...
        if (vm.mapOptions.maximumZoom) {
          vm.enableMaximumZoomCheck = true;
        }
      ...
      vm.initializeMap = function() {
        ...
        if (lazyInitMap) {
          ...
          for (var group in lazyInitMap) {
            var groupMembers = lazyInitMap[group];
    ...
    __MapController.$inject = ['$scope', '$element', '$attrs', '$parse', 'Attr2MapOptions', 'NgMap', 'NgMapPool'];
      ...
      CustomMarker.prototype.setPosition = function(position) {
        ...
        if (this.getProjection() && typeof this.position.lng == 'function') {
          ...
          var setPosition = function() {
            ...
            var y = Math.round(posPixel.y - _this.el.offsetHeight - 10);
      ...
      var linkFunc = function(scope, element, attrs, mapController) {
        ...
        mapController.showInfoWindow = mapController.map.showInfoWindow = mapController.showInfoWindow || function(p1, p2, p3) {
          ...
          if (typeof marker == 'string') {
            ...
            } else if (typeof mapController.map.customMarkers && typeof mapController.map.customMarkers[marker] != "undefined") {
  ...
  (function() {
    ...
    var Attr2MapOptions = function($parse, $timeout, $log, NavigatorGeolocation, GeoCoder, camelCaseFilter, jsonizeFilter) {
      ...
      var toOptionValue = function(input, options) {
        ...
        if ((options.key == 'center' || options.key == 'center') && output instanceof Array) {
          output = new google.maps.LatLng(output[0], output[1]);
        }
...
$__System.register("9", [], function (_export) {
	...
	function MainCtrl(allParksSrv) {
		...
		allParksSrv.success(function (response) {
...
$__System.register("b", [], function (_export) {
	...
	return {
		setters: [],
		execute: function () {
			_export("default", headerDirective);
		}
	};
});
$__System.register("c", [], function (_export) {
	...
	return {
		setters: [],
		execute: function () {
			_export("default", highestRankedItems);
		}
	};
});
$__System.register("d", [], function (_export) {
	...
	function recentlyAddedItems() {
		...
		return {
			...
			"restrict": "E",
			"templateUrl": "../../../views/recently-added-items.view.html",
			"replace": true
	...
	return {
		setters: [],
		execute: function () {
			_export("default", recentlyAddedItems);
		}
	};
});
$__System.register("e", [], function (_export) {
	...
	function filterItemsByTag() {
		...
		return {
			...
			"restrict": "E",
			"templateUrl": "../../../views/filter-items-by-tag.view.html",
			"replace": true
	...
	return {
		setters: [],
		execute: function () {
			_export("default", filterItemsByTag);
		}
	};
});
$__System.register("f", [], function (_export) {
	...
	function infoTriangle() {

		return {

			"restrict": "E",
			"templateUrl": "../../../views/info-triangle.view.html",
			"replace": true
...
$__System.register("10", [], function (_export) {
	...
	return {
		setters: [],
		execute: function () {
			_export("default", searchDirective);
		}
	};
});
$__System.register("1", ["3", "5", "7", "8", "9", "10", "a", "b", "c", "d", "e", "f"], function (_export) {
	...
	// controllers
	var angular, ngMap, $, allParksSrv, MainCtrl, searchBar, MapCtrl, headerGraphic, highestRankedItems, recentlyAddedItems, filterItemsByTag, infoTriangle;
	return {
		setters: [function (_) {
			angular = _["default"];
		}, function (_2) {
			...
			allParksSrv = _4["default"];
		}, function (_5) {
			MainCtrl = _5["default"];
		}, function (_6) {
			searchBar = _6["default"];
		}, function (_a) {
			MapCtrl = _a["default"];
		}, function (_b) {
			headerGraphic = _b["default"];
		}, function (_c) {
			highestRankedItems = _c["default"];
		}, function (_d) {
			recentlyAddedItems = _d["default"];
		}, function (_e) {
			filterItemsByTag = _e["default"];
		}, function (_f) {
			infoTriangle = _f["default"];
		}],
		execute: function () {

			console.log($);angular.module("ngSkateApp", ["ngMap"]).controller("MainCtrl", MainCtrl).controller("MapCtrl", MapCtrl).directive("headerGraphic", headerGraphic).directive("highestRankedItems", highestRankedItems).directive("recentlyAddedItems", recentlyAddedItems).directive("infoTriangle", infoTriangle).directive("filterItemsByTag", filterItemsByTag).directive("searchBar", searchBar).service("allParksSrv", allParksSrv);
		}
	};
});
})
